...
def main(argv=None):
    ...
    df['previous_token'] = df['token'].shift(1)
    ...
    new_df = df[['story', 'sent_index', 'token_index', 'previous_token', 'token', 'next_token', 'pos', 'chunk', 'lemma', 'matchesNeg', 'hasPrefix', 'hasSuffix', 'hasPrefixAntonym', 'hasSuffixAntonym', 'matchesMulticue', 'bio']]
